...
public class ProductTask1 {
    ...
    //自定义分区
    static class ProductPartitioner extends Partitioner<Text, Text> {
        @Override
        public int getPartition(Text productId, Text sale_time, int i) {
            int partId = 0;
            if ("1511A".equals(productId.toString())) {
                partId = 0;
            } else if ("1511B".equals(productId.toString())) {
                partId = 1;
            } else if ("1511C".equals(productId.toString())) {
                partId = 2;
            } else if ("1511D".equals(productId.toString())) {
                partId = 3;
            }
            return partId;
        }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            job.setJarByClass(ProductTask1.class);
            //设置Mapper
